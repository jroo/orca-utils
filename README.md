...
- **Key generator module**: Given a root and a key, create eight variables to hold each note in the key. [More info](key-generator/key-generator.md).
